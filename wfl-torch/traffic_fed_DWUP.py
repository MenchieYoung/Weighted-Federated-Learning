...
from models.Update_mod import LocalUpdate_traffic_DWUP
...
#            lc_res=[] 
#            lc_res=np.array(lc_res)
            local = LocalUpdate_traffic_DWUP(train_dataset=Traffic(datasets[idx]),test_dataset=Traffic(testsets[idx]), idxs=dict_users[idx])
